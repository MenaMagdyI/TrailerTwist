...
public class FavoriteProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(FavoriteContract.CONTENT_AUTHORITY, FavoriteContract.PATH_MOVIES, MOVIES_CODE);
        matcher.addURI(FavoriteContract.CONTENT_AUTHORITY, FavoriteContract.PATH_MOVIES + "/#", MOVIES_WITH_ID_CODE);
        matcher.addURI(FavoriteContract.CONTENT_AUTHORITY, FavoriteContract.PATH_REVIEWS, REVIEWS_CODE);
        matcher.addURI(FavoriteContract.CONTENT_AUTHORITY, FavoriteContract.PATH_TRAILERS, TRAILERS_CODE);
        return matcher;
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (code) {
            case MOVIES_CODE:
                returnedCursor = sqLiteDatabase.query(FavoriteContract.MovieEntry.TABLE_NAME, projection, selection, selectionArgs, null, null, sortOrder);
                break;

            case MOVIES_WITH_ID_CODE:
                String id = uri.getPathSegments().get(1);
                String mSelection = FavoriteContract.MovieEntry._ID + "=?";
                String[] mSelectionArgs = new String[]{id};
                returnedCursor = sqLiteDatabase.query(FavoriteContract.MovieEntry.TABLE_NAME, projection, mSelection, mSelectionArgs, null, null, sortOrder);
                break;
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        switch (code) {
            case MOVIES_CODE:
                insertedId = sqLiteDatabase.insert(FavoriteContract.MovieEntry.TABLE_NAME, null, values);
                if (insertedId > 0) {
                    insertedUri = FavoriteContract.MovieEntry.CONTENT_URI.buildUpon().appendPath(String.valueOf(insertedId)).build();
                } else {
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (code) {
            case MOVIES_CODE:
                deleterRows = sqLiteDatabase.delete(FavoriteContract.MovieEntry.TABLE_NAME, selection, selectionArgs);
                break;
            case MOVIES_WITH_ID_CODE:
                String id = uri.getPathSegments().get(1);
                String mSelection = FavoriteContract.MovieEntry._ID + "=?";
                String[] mSelectionArgs = new String[]{id};
                deleterRows = sqLiteDatabase.delete(FavoriteContract.MovieEntry.TABLE_NAME, mSelection, mSelectionArgs);
                break;
